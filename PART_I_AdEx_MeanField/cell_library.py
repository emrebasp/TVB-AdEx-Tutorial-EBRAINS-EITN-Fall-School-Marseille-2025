...
def get_neuron_params(NAME, name='', number=1, SI_units=False):
    ...
    if NAME=='LIF':
        ...
        params = {'name':name, 'N':number,\
                  'Gl':10., 'Cm':150.,'Trefrac':5.,\
                  'El':-60., 'Vthre':-50., 'Vreset':-60., 'delta_v':2.,\
                  'a':4., 'b':20., 'tauw':500., 'Ntot':10000}

    # elif NAME=='FS-cell':
    #     params = {'name':name, 'N':number,\
    #               'Gl':10., 'Cm':200.,'Trefrac':5,\
    #               'El':-65., 'Vthre':-50., 'Vreset':-65., 'delta_v':0.5,'ampnoise':0.,\
    #               'a':0., 'b': 0., 'tauw':1e9, 'Ntot':10000, 'pconnec':0.05, 'gei':0.02}

    elif NAME=='FS-cell':
        params = {'name':name, 'N':number,\
                  'Gl':10., 'Cm':200.,'Trefrac':5,\
                  'El':-65., 'Vthre':-50., 'Vreset':-65., 'delta_v':0.5,'ampnoise':0.,\
                  'a':0., 'b': 0., 'tauw':1, 'Ntot':10000, 'pconnec':0.05, 'gei':0.02}
    
    elif NAME=='RS-cell':
        params = {'name':name, 'N':number,\
                  'Gl':10., 'Cm':200.,'Trefrac':5,\
                  'El':-65., 'Vthre':-50., 'Vreset':-65., 'delta_v':2.,'ampnoise':0.,\
                  'a':4., 'b':40., 'tauw':500., 'Ntot':10000, 'pconnec':0.05, 'gei':0.02}

    elif NAME=='RS-cellbis':
        params = {'name':name, 'N':number,\
                'Gl':10., 'Cm':200.,'Trefrac':5,\
                'El':-65., 'Vthre':-50., 'Vreset':-65., 'delta_v':2.,'ampnoise':0.,\
                'a':0., 'b':100., 'tauw':500., 'Ntot':10000, 'pconnec':0.05, 'gei':0.02}
    ...
    #                 'a':0., 'b':40., 'tauw':5000., 'Ntot':10000, 'pconnec':0.05, 'gei':0.02}

    elif NAME=='RS-cell_UD':
        params = {'name':name, 'N':number,\
            'Gl':10., 'Cm':200.,'Trefrac':5,\
                'El':-63., 'Vthre':-50., 'Vreset':-65., 'delta_v':2,'ampnoise':0.,\
                    'a':0., 'b':40., 'tauw':500., 'Ntot':10000, 'pconnec':0.05, 'gei':0.02}
